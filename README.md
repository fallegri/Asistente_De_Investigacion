...
- Guía al estudiante por 5 fases: Diagnóstico → Objetivos → 
  Literatura → Metodología → Exportación
- Valida objetivos con la Taxonomía de Bloom en tiempo real
- Usa IA (Google Gemini) para retroalimentación socrática
- Calcula muestras estadísticas automáticamente (fórmula Cochran)
- Exporta el perfil completo a .docx en formato APA 7

## Stack

Next.js 14 · Supabase · Google Gemini · Tailwind CSS · TypeScript
...
Edita `.env.local` con tus credenciales (ver sección de servicios externos).

### 3. Ejecutar migraciones en Supabase

Ejecuta los archivos en `/supabase/migrations/` en orden (001 → 005) 
