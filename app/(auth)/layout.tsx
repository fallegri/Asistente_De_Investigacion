...
export const metadata: Metadata = {
  title: 'Acceso — Asistente de Investigación',
}
    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-[45%] relative bg-stone-900 flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-white mt-6 leading-[1.1]"
            style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(2rem, 3vw, 2.75rem)' }}>
            Guía tu investigación<br />
            <span className="text-teal-400">con IA</span>
          </h1>
          <p className="text-stone-400 mt-4 text-sm leading-relaxed max-w-sm">
            ...
            con validación metodológica y asistencia inteligente en cada fase.
          </p>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-5 py-10 sm:px-10 lg:px-16 bg-[var(--color-surface)]">
        ...
        <div className="lg:hidden flex items-center gap-2 mb-8">
          ...
          <span className="text-sm font-bold text-stone-700">Asistente de Investigación</span>
        </div>
