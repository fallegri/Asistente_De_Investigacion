...
function NewProjectModal({
  ...
  const handleSubmit = async () => {
    if (!form.institucion.trim())  { setError('El nombre de la institución es obligatorio.'); return }
    ...
    if (dbErr) {
      setError(`Error al crear el proyecto: ${dbErr.message}`)
      setSaving(false)
      return
    }
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto animate-fade-in-up">
        <div className="p-6 space-y-5">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-semibold mb-1.5">
                Área de estudio / Empresa o contexto *
              </label>
              <input
                type="text"
